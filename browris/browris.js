...
(function() {
  ...
  class Setup
  {
    static init()
    {
      ...
      html = '<svg version="1.1" id="orgblock" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="display:none;" viewBox="0 0 16 16" width="16px" height="16px">'
           + '<defs>'
